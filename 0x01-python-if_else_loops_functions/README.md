...
This project focusses on python indetations, string formatters and the types of ways that they can be used to manipulate various output.
It teaches you how to integrate the different data types, convert the differnet data types also to manipulate the different data types so that they all work together to construct different code.

The following project's instructions are as follows:
